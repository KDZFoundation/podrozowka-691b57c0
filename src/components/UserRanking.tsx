  ...
  useEffect(() => {
    const fetchRanking = async () => {
      const { data, error } = await supabase
        .from('profiles')
        .select('id, display_name, avatar_url, country, postcards_given')
        .gt('postcards_given', 0)
        .order('postcards_given', { ascending: false })
        .limit(10);
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              Dołącz do społeczności, rozdawaj Podróżówki i zostań jednym z naszych ambasadorów promujących Polskę na świecie.
            </p>
            <a 
              href="#auth"
    ...
    <section className="py-16 bg-secondary">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Najwięksi ambasadorzy Polski
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Użytkownicy, którzy rozdali najwięcej Podróżówek i pomagają promować Polskę na świecie.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex-shrink-0 text-right">
                <p className="font-display text-xl font-bold text-primary">
                  {user.postcards_given}
                </p>
                <p className="text-xs text-muted-foreground">rozdanych</p>
              </div>
            </motion.div>
          ))}
        </div>
